...
const ProfileDetails = ({ profile, params }) => {
  ...
  const handleEditSubmit = async (e) => {
    e.preventDefault();
    setError("");
    const { name, about, designation, mobile, location } = profileToEdit;
  ...
  return (
    <div className="p-3 my-5 container">
      <div className="text-center text-gray-900 dark:text-white font-semibold text-lg pb-8 md:pb-20">
        <h2>Profile</h2>
      </div>
        ...
        <div className="flex-1 space-y-3">
          ...
          <div className="pt-5">
            {profile?._id === session?.user?._id && (
              <Button className="mr-3" onClick={() => setOpenModalEdit(true)}>
                Edit
              </Button>
            )}
            ...
            <Modal modalOpen={openModalEdit} setModalOpen={setOpenModalEdit}>
              <form className="w-full space-y-3" onSubmit={handleEditSubmit}>
                <h2 className="text-2xl text-center pb-3">Profile</h2>
                ...
                <div className="space-x-5">
                  ...
                  <Button
                    className="btn bg-red-700 hover:bg-red-500 dark:text-white"
