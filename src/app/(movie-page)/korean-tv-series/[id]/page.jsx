...
const SingleKoreanSeriesPage = async ({ params }) => {
  ...
  return (
    <>
        ...
        <div className="md:col-span-4 space-y-3">
          ...
          <div className="flex items-start gap-2">
            ...
            <p className="text-justify">
              <span className="font-medium">Storyline:</span> {description}
            </p>
          </div>
          <iframe
      ...
      {/* Share Series */}
      <ShareMovieSocial _id={_id} movieCategory={`korean-tv-series`} />
        ...
        <div className="mt-4">
          ...
          <div className="grid grid-cols-3 md:grid-cols-6 gap-2 md:gap-4">
            {similarWebSeries.map((similarWeb) => (
              <Link
                href={`/korean-tv-series/${similarWeb._id}`}
...
export default SingleKoreanSeriesPage;
