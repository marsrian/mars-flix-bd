...
const SingleBanglaWebSeriesPage = async ({ params }) => {
  ...
  return (
    <>
      ...
      {/* Share Series */}
      <ShareMovieSocial _id={_id} movieCategory={`bangla-web-series`} />
        ...
        <div className="mt-4">
          ...
          <div className="grid grid-cols-3 md:grid-cols-6 gap-2 md:gap-4">
            {similarWebSeries.map((similarWeb) => (
              <Link
                href={`/bangla-web-series/${similarWeb._id}`}
...
export default SingleBanglaWebSeriesPage;
