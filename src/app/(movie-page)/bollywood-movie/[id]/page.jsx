...
const SingleBollywoodMoviePage = async ({ params }) => {
  ...
  return (
    <>
      ...
      {/* Share Movie */}
      <ShareMovieSocial _id={_id} movieCategory={`bollywood-movie`} />
        ...
        <div className="mt-4">
          ...
          <div className="grid grid-cols-3 md:grid-cols-6 gap-2 md:gap-4">
            {similarMovies.map((similarMovie) => (
              <Link
                href={`/bollywood-movie/${similarMovie._id}`}
...
export default SingleBollywoodMoviePage;
