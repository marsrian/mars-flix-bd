...
const TermsAndConditionsPage = () => {
  return (
    <div className="my-8 md:my-12 px-4 md:px-8">
      <h1 className="text-2xl md:text-3xl font-bold">TERMS AND CONDITIONS</h1>
      <h6 className="font-medium text-gray-600 dark:text-white mt-4 mb-6">
        Last updated July 25, 2024
      </h6>
      <h3 className="text-xl font-semibold mb-3">
        AGREEMENT TO OUR LEGAL TERMS
      </h3>
      <p className="mb-2 text-justify text-gray-700 dark:text-white">
        We are MarsFlixBD (
        <span className="font-medium">&quot;Company,&quot;</span>{" "}
        <span className="font-medium">&quot;we,&quot;</span>{" "}
        <span className="font-medium">&quot;us,&quot;</span>
        <span className="font-medium">&quot;our&quot;</span>), a company
        registered in Bangladesh at Sylhet, Sylhet, Sylhet 3000.
      </p>
      <p className="mb-2 text-justify text-gray-700 dark:text-white">
        We operate the website{" "}
        <Link href="/" className="text-blue-600">
          https://marsflixbd.vercel.app
        </Link>{" "}
        (the <span className="font-semibold">&quot;Site&quot;</span>), as well
      ...
      <p className="mb-2 text-justify text-gray-700 dark:text-white">
        Download the latest anime, Bangla, Bollywood, Hollywood movies, and
        series for free at MarsFlixBD. Enjoy high-quality content with easy
        downloads.
      </p>
      <p className="mb-2 text-justify text-gray-700 dark:text-white">
        You can contact us by email at marsrian40@gmail.com or by mail to
        Sylhet, Sylhet, Sylhet 3000, Bangladesh.
      </p>
      <p className="mb-2 text-justify text-gray-700 dark:text-white">
        These Legal Terms constitute a legally binding agreement made between
        you, whether personally or on behalf of an entity (<span className="font-semibold">&quot;you&quot;</span>), and
        MarsFlixBD, concerning your access to and use of the Services. You agree
      ...
      <p className="mb-8 text-justify text-gray-700 dark:text-white">
      ...
      <ul>
        <li>
          <Link href="#our_service" className="text-blue-600">
            1. OUR SERVICES
          </Link>
        </li>
        <li>
          <Link href="#intellectual_property" className="text-blue-600">
            2. INTELLECTUAL PROPERTY RIGHTS
          </Link>
        </li>
        <li>
          <Link href="#user_representations" className="text-blue-600">
            3. USER REPRESENTATIONS
          </Link>
        </li>
        <li>
          <Link href="#user_registration" className="text-blue-600">
            4. USER REGISTRATION
          </Link>
        </li>
        <li>
          <Link href="#prohibited_activities" className="text-blue-600">
            5. PROHIBITED ACTIVITIES
          </Link>
        </li>
        <li>
          <Link href="#user_generated_contributions" className="text-blue-600">
            6. USER GENERATED CONTRIBUTIONS
          </Link>
        </li>
        <li>
          <Link href="#contribution_license" className="text-blue-600">
            7. CONTRIBUTION LICENSE
          </Link>
        </li>
        <li>
          <Link href="#guideline_review" className="text-blue-600">
            8. GUIDELINES FOR REVIEWS
          </Link>
        </li>
        <li>
          <Link href="#social_media" className="text-blue-600">
            9. SOCIAL MEDIA
          </Link>
        </li>
        <li>
          <Link href="#third_party_website" className="text-blue-600">
            10. THIRD-PARTY WEBSITES AND CONTENT
          </Link>
        </li>
        <li>
          <Link href="#advertisers" className="text-blue-600">
            11. ADVERTISERS
          </Link>
        </li>
        <li>
          <Link href="#services_management" className="text-blue-600">
        ...
        <li>
          <Link href="#copyright_infringements" className="text-blue-600">
            14. COPYRIGHT INFRINGEMENTS
          </Link>
        </li>
        <li>
          <Link href="#term_termination" className="text-blue-600">
        ...
        <li>
          <Link href="#governing_law" className="text-blue-600">
            17. GOVERNING LAW
          </Link>
        </li>
        <li>
          <Link href="#dispute_resolution" className="text-blue-600">
            18. DISPUTE RESOLUTION
          </Link>
        </li>
        <li>
          <Link href="#corrections" className="text-blue-600">
            19. CORRECTIONS
          </Link>
        </li>
        <li>
        ...
        <li>
          <Link href="#limitations" className="text-blue-600">
        ...
        <li>
          <Link href="#user_data" className="text-blue-600">
            23. USER DATA
          </Link>
        </li>
        <li>
          <Link href="#communication_transaction" className="text-blue-600">
            24. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES
          </Link>
        </li>
        <li>
          <Link href="#california_user" className="text-blue-600">
            25. CALIFORNIA USERS AND RESIDENTS
          </Link>
        </li>
        <li>
          <Link href="#miscellaneous" className="text-blue-600">
            26. MISCELLANEOUS
          </Link>
        </li>
        <li>
          <Link href="#contact_us" className="text-blue-600">
            27. CONTACT US
          </Link>
        </li>
      </ul>
      <h3 id="our_service" className="text-xl font-bold mt-10 mb-6">
        1. OUR SERVICES
      </h3>
      <p className="mb-3 text-justify text-gray-700 dark:text-white">
      ...
      <p className="mb-5 text-justify text-gray-700 dark:text-white">
      ...
      <h3 id="intellectual_property" className="text-xl font-bold mb-6">
        2. INTELLECTUAL PROPERTY RIGHTS
      </h3>
      <h6 className="text-lg font-semibold mb-4">Our intellectual property</h6>
      <p className="mb-4 text-justify text-gray-700 dark:text-white">
      ...
      <h6 className="text-lg font-semibold mb-4">Your use of our Services</h6>
      <p className="mb-4 text-justify text-gray-700 dark:text-white">
      ...
      <ul className="mb-4 ml-6 md:ml-10 text-gray-700 dark:text-white">
        <li className="list-disc">access the Services; and</li>
      ...
      <p className="mb-4 text-justify text-gray-700 dark:text-white">
        ...
        address your request to: marsrian40@gmail.com. If we ever grant you the
      ...
      <p className="mb-4 text-justify text-gray-700 dark:text-white">
        <span className="font-semibold">We may remove or edit your Content:</span> Although we have no
      ...
      <h6 className="text-lg font-semibold mb-4">Copyright infringement</h6>
      <p className="mb-4 text-justify text-gray-700 dark:text-white">
        We respect the intellectual property rights of others. If you believe
        that any material available on or through the Services infringes upon
        any copyright you own or control, please immediately refer to the <Link href="#copyright_infringements" className="text-blue-600">&quot;COPYRIGHT INFRINGEMENTS&quot;</Link> section below.
      </p>
      <h3 id="user_representations" className="text-xl font-bold mb-6">3. USER REPRESENTATIONS</h3>
      <p className="mb-4 text-justify text-gray-700 dark:text-white">
      ...
      <h3 id="user_registration" className="text-xl font-bold mb-6">4. USER REGISTRATION</h3>
      <p className="mb-4 text-justify text-gray-700 dark:text-white">
      ...
      <h3 id="prohibited_activities" className="text-xl font-bold mb-6">5. PROHIBITED ACTIVITIES</h3>
      <p className="mb-4 text-justify text-gray-700 dark:text-white">
      ...
      <p className="mb-4 text-justify text-gray-700 dark:text-white">As a user of the Services, you agree not to:</p>
      <ul className="mb-10 ml-6 md:ml-10 text-gray-700 dark:text-white">
        <li className="list-disc">
        ...
        <li className="list-disc">Sell or otherwise transfer your profile.</li>
      </ul>
      <h3 id="user_generated_contributions"  className="text-xl font-bold mb-6">6. USER GENERATED CONTRIBUTIONS</h3>
      <p className="mb-4 text-justify text-gray-700 dark:text-white">
      ...
      <ul className="mb-5 ml-6 md:ml-10 text-gray-700 dark:text-white">
      <li className="list-disc">
      ...
      <p className="mb-6 text-justify text-gray-700 dark:text-white">
        Any use of the Services in violation of the foregoing violates these
        Legal Terms and may result in, among other things, termination or
        suspension of your rights to use the Services.
      </p>
      <h3 id="contribution_license" className="text-xl font-bold mb-6">7. CONTRIBUTION LICENSE</h3>
      <p className="mb-4 text-justify text-gray-700 dark:text-white">
      ...
      <h3 id="guideline_review" className="text-xl font-bold mb-6">8. GUIDELINES FOR REVIEWS</h3>
      <p className="mb-4 text-justify text-gray-700 dark:text-white">
      ...
      <h3 id="social_media" className="text-xl font-bold mb-6">9. SOCIAL MEDIA</h3>
      <p className="mb-6 text-justify text-gray-700 dark:text-white">
      ...
      <h3 id="third_party_website" className="text-xl font-bold mb-6">10. THIRD-PARTY WEBSITES AND CONTENT</h3>
      <p className="mb-6 text-justify text-gray-700 dark:text-white">
      ...
      <h3 id="advertisers" className="text-xl font-bold mb-6">11. ADVERTISERS</h3>
      <p className="mb-6 text-justify text-gray-700 dark:text-white">
      ...
      <h3 id="services_management" className="text-xl font-bold mb-6">12. SERVICES MANAGEMENT</h3>
      <p className="mb-6 text-justify text-gray-700 dark:text-white">
      ...
      <h3 id="privacy_policy" className="text-xl font-bold mb-6">13. PRIVACY POLICY</h3>
      <p className="mb-6 text-justify text-gray-700 dark:text-white">
        We care about data privacy and security. Please review our Privacy
        Policy: htpps://marsflixbd.vercel.app/privacy-policy. By using the
        ...
        hosted in the United States and Bangladesh. If you access the Services
        ...
        applicable laws in the United States and Bangladesh, then through your
        continued use of the Services, you are transferring your data to the
        United States and Bangladesh, and you expressly consent to have your
        data transferred to and processed in the United States and Bangladesh.
      </p>
      <h3 id="copyright_infringements" className="text-xl font-bold mb-6">14. COPYRIGHT INFRINGEMENTS</h3>
      <p className="mb-6 text-justify text-gray-700 dark:text-white">
        We respect the intellectual property rights of others. If you believe
        that any material available on or through the Services infringes upon
      ...
      <h3 id="term_termination" className="text-xl font-bold mb-6">15. TERM AND TERMINATION</h3>
      <p className="mb-4 text-justify text-gray-700 dark:text-white">
      ...
      <h3 id="modification" className="text-xl font-bold mb-6">16. MODIFICATIONS AND INTERRUPTIONS</h3>
      <p className="mb-4 text-justify text-gray-700 dark:text-white">
      ...
      <h3 id="governing_law" className="text-xl font-bold mb-6">17. GOVERNING LAW</h3>
      <p className="mb-6 text-justify text-gray-700 dark:text-white">
        These Legal Terms shall be governed by and defined following the laws of
        Bangladesh. MarsFlixBD and yourself irrevocably consent that the courts
      ...
      <h3 id="dispute_resolution" className="text-xl font-bold mb-6">18. DISPUTE RESOLUTION</h3>
      <h6 className="text-lg font-semibold mb-5">Informal Negotiations</h6>
      <p className="mb-5 text-justify text-gray-700 dark:text-white">
      ...
      <h6 className="text-lg font-semibold mb-5">Binding Arbitration</h6>
      <p className="mb-5 text-justify text-gray-700 dark:text-white">
        ...
        be three (3). The seat, or legal place, or arbitration shall be Sylhet,
        Bangladesh. The language of the proceedings shall be English. The
        governing law of these Legal Terms shall be substantive law of
        Bangladesh.
      </p>
      <h6 className="text-lg font-semibold mb-5">Restrictions</h6>
      <p className="mb-5 text-justify text-gray-700 dark:text-white">
      ...
      <h6 className="text-lg font-semibold mb-5">Exceptions to Informal Negotiations and Arbitration</h6>
      <p className="mb-5 text-justify text-gray-700 dark:text-white">
      ...
      <h3 id="corrections" className="text-xl font-bold mb-6">19. CORRECTIONS</h3>
      <p className="mb-6 text-justify text-gray-700 dark:text-white">
      ...
      <h3 id="disclaimer" className="text-xl font-bold mb-6">20. DISCLAIMER</h3>
      <p className="mb-6 text-justify text-gray-700 dark:text-white">
      ...
      <h3 id="limitations" className="text-xl font-bold mb-6">21. LIMITATIONS OF LIABILITY</h3>
      <p className="mb-6 text-justify text-gray-700 dark:text-white">
      ...
      <h3 id="indemnification" className="text-xl font-bold mb-6">22. INDEMNIFICATION</h3>
      <p className="mb-6 text-justify text-gray-700 dark:text-white">
      ...
      <h3 id="user_data" className="text-xl font-bold mb-6">23. USER DATA</h3>
      <p className="mb-6 text-justify text-gray-700 dark:text-white">
      ...
      <h3 id="communication_transaction" className="text-xl font-bold mb-6">
        24. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES
      </h3>
      <p className="mb-6 text-justify text-gray-700 dark:text-white">
      ...
      <h3 id="california_user" className="text-xl font-bold mb-6">25. CALIFORNIA USERS AND RESIDENTS</h3>
      <p className="mb-6 text-justify text-gray-700 dark:text-white">
      ...
      <h3 id="miscellaneous" className="text-xl font-bold mb-6">26. MISCELLANEOUS</h3>
      <p className="mb-6 text-justify text-gray-700 dark:text-white">
      ...
      <h3 id="contact_us" className="text-xl font-bold mb-6">27. CONTACT US</h3>
      <p className="mb-6 text-justify text-gray-700 dark:text-white">
        In order to resolve a complaint regarding the Services or to receive
        further information regarding use of the Services, please contact us at:
      </p>
      <h6 className="font-semibold text-gray-600 dark:text-white">MarsFlixBD</h6>
      <h6 className="font-semibold text-gray-600 dark:text-white mb-3">Sylhet, Bangladesh</h6>
      <h6 className="font-semibold text-lg text-gray-600 dark:text-white">marsrian40@gmail.com</h6>
    </div>
  );
};
